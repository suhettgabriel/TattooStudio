...
namespace TattooStudio.Infrastructure.Migrations
{
    ...
    [Migration("20250726103348_AddSharedDocumentsAndConsent")]
    partial class AddSharedDocumentsAndConsent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TattooStudio.Core.Entities.EmailTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooStudio.Core.Entities.FaqItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooStudio.Core.Entities.GalleryImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooStudio.Core.Entities.PricingRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooStudio.Core.Entities.SharedDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TattooStudio.Core.Entities.SystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ConsentFormText")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsAgendaOpen")
                        .HasColumnType("bit");

                    b.Property<bool>("IsConsentFormEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TattooStudio.Core.Entities.TattooRequest", b =>
                {
                    ...
                    b.Property<decimal?>("InitialEstimate")
                        .HasColumnType("decimal(10, 2)");

                    b.Property<string>("MagicLinkToken")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("MagicLinkTokenExpiration")
                        .HasColumnType("datetime2");
